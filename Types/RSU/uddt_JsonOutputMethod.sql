...
CREATE PROCEDURE [RSU].[sp_ProcessJsonOutput]
    @Data [RSU].[uddt_JsonOutputMethod] READONLY
AS
BEGIN
    SET NOCOUNT ON;
...
DECLARE @Output [RSU].[uddt_JsonOutputMethod];

INSERT INTO @Output ([JsonOutPutMethod])
VALUES (N'{"key":"value"}');

EXEC [RSU].[sp_ProcessJsonOutput] @Data = @Output;
*/
