DROP PROCEDURE IF EXISTS [GEN].[spExceptionsThrown];
GO

/******************************************************************************
**		File: spExceptionsThrown.sql
**		Name: spExceptionsThrown
**		Desc: 
**
...
**	-----------	---------------	-------------------------------------------
**	01/28/2016	Andres Sosa		Created By
**	
*******************************************************************************/
CREATE   Procedure [GEN].[spExceptionsThrown]
--(
--	@PARAM INT
...
BEGIN
	...
	SELECT
		...
		, @ERROR_MESSAGE = REPLACE(REPLACE(ERROR_MESSAGE(), '"', '[doubleQuote]'), ':', '[colon]')-- AS ErrorMessage
...
END
GRANT EXECUTE
    ON OBJECT::[GEN].[spExceptionsThrown] TO PUBLIC
    AS [dbo];
