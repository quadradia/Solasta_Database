...
FROM sys.tables
WHERE name = 'UserRecruits' AND schema_id = SCHEMA_ID('RSU'))
BEGIN
...
IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'DF_UserRecruits_ModifiedDate' AND type = 'D')
...
ALTER TABLE [RSU].[UserRecruits]  WITH CHECK ADD  CONSTRAINT [FK_UserRecruits_DealerTenants] FOREIGN KEY([DealerTenantId])
REFERENCES [ACC].[DealerTenants] ([DealerTenantID])
GO

IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_UserRecruits_Season')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_UserRecruits_Teams')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_UserRecruits_UserRecruitAddresses')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_UserRecruits_UserRecruitCohabbitTypes')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_UserRecruits_UserResources')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_UserRecruits_UserTypes')
...
ALTER TABLE [RSU].[UserRecruits] CHECK CONSTRAINT [FK_UserRecruits_DealerTenants]
GO
