...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'UserResources' AND schema_id = SCHEMA_ID('RSU'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_UserResources_RecruitedDate_1' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_UserResources_IsActive' AND type = 'D')
ALTER TABLE [RSU].[UserResources] ADD  CONSTRAINT [DF_UserResources_IsActive]  DEFAULT ((1)) FOR [IsActive]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_UserResources_IsDeleted' AND type = 'D')
ALTER TABLE [RSU].[UserResources] ADD  CONSTRAINT [DF_UserResources_IsDeleted]  DEFAULT ((0)) FOR [IsDeleted]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_UserResources_ModifiedDate' AND type = 'D')
ALTER TABLE [RSU].[UserResources] ADD  CONSTRAINT [DF_UserResources_ModifiedDate]  DEFAULT (sysdatetimeoffset()) FOR [ModifiedDate]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_UserResources_ModifiedById' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_UserResources_CreatedDate' AND type = 'D')
ALTER TABLE [RSU].[UserResources] ADD  CONSTRAINT [DF_UserResources_CreatedDate]  DEFAULT (sysdatetimeoffset()) FOR [CreatedDate]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_UserResources_CreatedById' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_UserResources_DEX_ROW_TS' AND type = 'D')
ALTER TABLE [RSU].[UserResources] ADD  CONSTRAINT [DF_UserResources_DEX_ROW_TS]  DEFAULT (sysdatetimeoffset()) FOR [DEX_ROW_TS]
GO

IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_UserResources_Dealers')
ALTER TABLE [RSU].[UserResources]  WITH CHECK ADD  CONSTRAINT [FK_UserResources_Dealers] FOREIGN KEY([DealerId])
REFERENCES [ACC].[Dealers] ([DealerID])
GO

IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_UserResources_UserEmployeeTypes')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_UserResources_UserResourceAddresses')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_UserResources_Users')
...
ALTER TABLE [RSU].[UserResources] CHECK CONSTRAINT [FK_UserResources_Dealers]
GO
