...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Seasons' AND schema_id = SCHEMA_ID('RSU'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Seasons_IsCurbNSign' AND type = 'D')
ALTER TABLE [RSU].[Seasons] ADD  CONSTRAINT [DF_Seasons_IsCurbNSign]  DEFAULT ((0)) FOR [IsCurbNSign]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Season_IsActive' AND type = 'D')
ALTER TABLE [RSU].[Seasons] ADD  CONSTRAINT [DF_Season_IsActive]  DEFAULT ((1)) FOR [IsActive]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Season_IsDeleted' AND type = 'D')
ALTER TABLE [RSU].[Seasons] ADD  CONSTRAINT [DF_Season_IsDeleted]  DEFAULT ((0)) FOR [IsDeleted]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Season_ModifiedDate' AND type = 'D')
ALTER TABLE [RSU].[Seasons] ADD  CONSTRAINT [DF_Season_ModifiedDate]  DEFAULT (sysdatetimeoffset()) FOR [ModifiedDate]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Season_ModifiedById' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Season_CreatedDate' AND type = 'D')
ALTER TABLE [RSU].[Seasons] ADD  CONSTRAINT [DF_Season_CreatedDate]  DEFAULT (sysdatetimeoffset()) FOR [CreatedDate]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Season_CreatedById' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Seasons_DEX_ROW_TS' AND type = 'D')
ALTER TABLE [RSU].[Seasons] ADD  CONSTRAINT [DF_Seasons_DEX_ROW_TS]  DEFAULT (sysdatetimeoffset()) FOR [DEX_ROW_TS]
GO

IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Season_Dealers')
ALTER TABLE [RSU].[Seasons]  WITH CHECK ADD  CONSTRAINT [FK_Season_Dealers] FOREIGN KEY([DealerId])
REFERENCES [ACC].[Dealers] ([DealerID])
GO

ALTER TABLE [RSU].[Seasons] CHECK CONSTRAINT [FK_Season_Dealers]
GO
