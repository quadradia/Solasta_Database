...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'MasterFileAccounts' AND schema_id = SCHEMA_ID('ACE'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_MasterFileAccounts_CustomerTypeId' AND type = 'D')
ALTER TABLE [ACE].[MasterFileAccounts] ADD  CONSTRAINT [DF_MasterFileAccounts_CustomerTypeId]  DEFAULT ('LEAD') FOR [CustomerTypeId]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_MasterFileAccounts_EffectiveDate' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_MasterFileAccounts_IsActive' AND type = 'D')
ALTER TABLE [ACE].[MasterFileAccounts] ADD  CONSTRAINT [DF_MasterFileAccounts_IsActive]  DEFAULT ((1)) FOR [IsActive]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_MasterFileAccounts_IsDeleted' AND type = 'D')
ALTER TABLE [ACE].[MasterFileAccounts] ADD  CONSTRAINT [DF_MasterFileAccounts_IsDeleted]  DEFAULT ((0)) FOR [IsDeleted]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_MasterFileAccounts_ModifiedDate' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_MasterFileAccounts_ModifiedById' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_MasterFileAccounts_CreatedDate' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_MasterFileAccounts_CreatedById' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_MasterFileAccounts_DEX_ROW_TS' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_MasterFileAccounts_Accounts')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_MasterFileAccounts_AccountTypes')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_MasterFileAccounts_Customers')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_MasterFileAccounts_CustomerTypes')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_MasterFileAccounts_Dealers')
ALTER TABLE [ACE].[MasterFileAccounts]  WITH CHECK ADD  CONSTRAINT [FK_MasterFileAccounts_Dealers] FOREIGN KEY([DealerId])
REFERENCES [ACC].[Dealers] ([DealerID])
GO

IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_MasterFileAccounts_Leads')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_MasterFileAccounts_MasterFiles')
...
ALTER TABLE [ACE].[MasterFileAccounts] CHECK CONSTRAINT [FK_MasterFileAccounts_Dealers]
GO
