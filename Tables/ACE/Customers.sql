...
ALTER TABLE [ACE].[Customers]  WITH CHECK ADD  CONSTRAINT [FK_Customers_DealerTenants] FOREIGN KEY([DealerTenantId])
REFERENCES [ACC].[DealerTenants] ([DealerTenantID])
GO

IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_Customers_Languages')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_Customers_MasterFiles')
...
ALTER TABLE [ACE].[Customers] CHECK CONSTRAINT [FK_Customers_DealerTenants]
GO
