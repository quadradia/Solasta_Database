...
IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'DF_MasterFiles_DEX_ROW_TS' AND type = 'D')
...
ALTER TABLE [ACE].[MasterFiles]  WITH CHECK ADD  CONSTRAINT [FK_MasterFiles_DealerTenants] FOREIGN KEY([DealerTenantId])
REFERENCES [ACC].[DealerTenants] ([DealerTenantID])
GO

ALTER TABLE [ACE].[MasterFiles] CHECK CONSTRAINT [FK_MasterFiles_DealerTenants]
GO
