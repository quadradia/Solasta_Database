...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'CustomerAddresses' AND schema_id = SCHEMA_ID('ACE'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_CustomerAddresses_IsActive' AND type = 'D')
ALTER TABLE [ACE].[CustomerAddresses] ADD  CONSTRAINT [DF_CustomerAddresses_IsActive]  DEFAULT ((1)) FOR [IsActive]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_CustomerAddresses_IsDeleted' AND type = 'D')
ALTER TABLE [ACE].[CustomerAddresses] ADD  CONSTRAINT [DF_CustomerAddresses_IsDeleted]  DEFAULT ((0)) FOR [IsDeleted]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_CustomerAddresses_ModifiedDate' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_CustomerAddresses_ModifiedById' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_CustomerAddresses_CreatedDate' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_CustomerAddresses_CreatedById' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_CustomerAddresses_DEX_ROW_TS' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Addresses_AddressTypes')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Addresses_AddressValidationStates')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Addresses_AddressValidationVendors')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Addresses_Dealers')
ALTER TABLE [ACE].[CustomerAddresses]  WITH CHECK ADD  CONSTRAINT [FK_Addresses_Dealers] FOREIGN KEY([DealerId])
REFERENCES [ACC].[Dealers] ([DealerID])
GO

IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Addresses_PoliticalCountries')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Addresses_PoliticalStates')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_CustomerAddresses_AddressStreetTypes')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_CustomerAddresses_LeadAddresses')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_CustomerAddresses_PoliticalTimeZones')
...
ALTER TABLE [ACE].[CustomerAddresses] CHECK CONSTRAINT [FK_Addresses_Dealers]
GO
