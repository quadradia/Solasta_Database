...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'PremiseAddresses' AND schema_id = SCHEMA_ID('MAS'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_PremiseAddresses_LanguageId' AND type = 'D')
ALTER TABLE [MAS].[PremiseAddresses] ADD  CONSTRAINT [DF_PremiseAddresses_LanguageId]  DEFAULT (N'en') FOR [LanguageId]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_PremiseAddresses_IsActive' AND type = 'D')
ALTER TABLE [MAS].[PremiseAddresses] ADD  CONSTRAINT [DF_PremiseAddresses_IsActive]  DEFAULT ((1)) FOR [IsActive]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_PremiseAddresses_IsDeleted' AND type = 'D')
ALTER TABLE [MAS].[PremiseAddresses] ADD  CONSTRAINT [DF_PremiseAddresses_IsDeleted]  DEFAULT ((0)) FOR [IsDeleted]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_PremiseAddresses_ModifiedDate' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_PremiseAddresses_ModifiedById' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_PremiseAddresses_CreatedDate' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_PremiseAddresses_CreatedById' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_PremiseAddresses_DEX_ROW_TS' AND type = 'D')
ALTER TABLE [MAS].[PremiseAddresses] ADD  CONSTRAINT [DF_PremiseAddresses_DEX_ROW_TS]  DEFAULT (sysdatetimeoffset()) FOR [DEX_ROW_TS]
GO

IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PremiseAddresses_AddressStreetTypes')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PremiseAddresses_AddressTypes')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PremiseAddresses_AddressValidationStates')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PremiseAddresses_AddressValidationVendors')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PremiseAddresses_Dealers')
ALTER TABLE [MAS].[PremiseAddresses]  WITH CHECK ADD  CONSTRAINT [FK_PremiseAddresses_Dealers] FOREIGN KEY([DealerId])
REFERENCES [ACC].[Dealers] ([DealerID])
GO

IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PremiseAddresses_Languages')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PremiseAddresses_LeadAddresses')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PremiseAddresses_PoliticalCountries')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PremiseAddresses_PoliticalStates')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PremiseAddresses_PoliticalTimeZones')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PremiseAddresses_Seasons')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_PremiseAddresses_TeamLocations')
...
ALTER TABLE [MAS].[PremiseAddresses] CHECK CONSTRAINT [FK_PremiseAddresses_Dealers]
GO
