...
FROM sys.tables
WHERE name = 'MasAccountTemplates' AND schema_id = SCHEMA_ID('MAS'))
BEGIN
...
IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'DF_MasAccountTemplates_TemplateName' AND type = 'D')
...
IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'DF_MasAccountTemplates_ModifiedById' AND type = 'D')
...
IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'DF_MasAccountTemplates_CreatedDate' AND type = 'D')
...
IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'DF_MasAccountTemplates_CreatedById' AND type = 'D')
...
IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'DF_MasAccountTemplates_DEX_ROW_TS' AND type = 'D')
...
ALTER TABLE [MAS].[MasAccountTemplates]  WITH CHECK ADD  CONSTRAINT [FK_MasAccountTemplates_DealerTenants] FOREIGN KEY([DealerTenantId])
REFERENCES [ACC].[DealerTenants] ([DealerTenantID])
GO

IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_MasAccountTemplates_MonitoringStationOperatingSystems')
...
ALTER TABLE [MAS].[MasAccountTemplates] CHECK CONSTRAINT [FK_MasAccountTemplates_DealerTenants]
GO
