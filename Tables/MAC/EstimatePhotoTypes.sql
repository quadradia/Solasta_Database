...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'EstimatePhotoTypes' AND schema_id = SCHEMA_ID('MAC'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_EstimatePhotoTypes_IsActive' AND type = 'D')
ALTER TABLE [MAC].[EstimatePhotoTypes] ADD  CONSTRAINT [DF_EstimatePhotoTypes_IsActive]  DEFAULT ((1)) FOR [IsActive]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_EstimatePhotoTypes_IsDeleted' AND type = 'D')
ALTER TABLE [MAC].[EstimatePhotoTypes] ADD  CONSTRAINT [DF_EstimatePhotoTypes_IsDeleted]  DEFAULT ((0)) FOR [IsDeleted]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_EstimatePhotoTypes_ModifiedDate' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_EstimatePhotoTypes_ModifiedById' AND type = 'D')
ALTER TABLE [MAC].[EstimatePhotoTypes] ADD  CONSTRAINT [DF_EstimatePhotoTypes_ModifiedById]  DEFAULT ((0)) FOR [ModifiedById]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_EstimatePhotoTypes_CreatedDate' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_EstimatePhotoTypes_CreatedById' AND type = 'D')
ALTER TABLE [MAC].[EstimatePhotoTypes] ADD  CONSTRAINT [DF_EstimatePhotoTypes_CreatedById]  DEFAULT ((0)) FOR [CreatedById]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_EstimatePhotoTypes_DEX_ROW_TS' AND type = 'D')
