...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Quotes' AND schema_id = SCHEMA_ID('MAC'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Quotes_IsActive' AND type = 'D')
ALTER TABLE [MAC].[Quotes] ADD  CONSTRAINT [DF_Quotes_IsActive]  DEFAULT ((1)) FOR [IsActive]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Quotes_IsDeleted' AND type = 'D')
ALTER TABLE [MAC].[Quotes] ADD  CONSTRAINT [DF_Quotes_IsDeleted]  DEFAULT ((0)) FOR [IsDeleted]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Quotes_ModifiedDate' AND type = 'D')
ALTER TABLE [MAC].[Quotes] ADD  CONSTRAINT [DF_Quotes_ModifiedDate]  DEFAULT (sysdatetimeoffset()) FOR [ModifiedDate]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Quotes_ModifiedById' AND type = 'D')
ALTER TABLE [MAC].[Quotes] ADD  CONSTRAINT [DF_Quotes_ModifiedById]  DEFAULT ((0)) FOR [ModifiedById]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Quotes_CreatedDate' AND type = 'D')
ALTER TABLE [MAC].[Quotes] ADD  CONSTRAINT [DF_Quotes_CreatedDate]  DEFAULT (sysdatetimeoffset()) FOR [CreatedDate]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Quotes_CreatedById' AND type = 'D')
ALTER TABLE [MAC].[Quotes] ADD  CONSTRAINT [DF_Quotes_CreatedById]  DEFAULT ((0)) FOR [CreatedById]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_Quotes_DEX_ROW_TS' AND type = 'D')
