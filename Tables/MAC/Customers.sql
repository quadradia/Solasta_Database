...
FROM sys.tables
WHERE name = 'Customers' AND schema_id = SCHEMA_ID('MAC'))
BEGIN
...
ALTER TABLE [MAC].[Customers]  WITH CHECK ADD  CONSTRAINT [FK_Customers_CustomerTypes] FOREIGN KEY([CustomerTypeId])
REFERENCES [MAC].[CustomerTypes] ([CustomerTypeID])
GO

ALTER TABLE [MAC].[Customers] CHECK CONSTRAINT [FK_Customers_CustomerTypes]
GO
