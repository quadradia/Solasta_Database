...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'LeadDispositions' AND schema_id = SCHEMA_ID('QAL'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_LeadDispositions_IsActive' AND type = 'D')
ALTER TABLE [QAL].[LeadDispositions] ADD  CONSTRAINT [DF_LeadDispositions_IsActive]  DEFAULT ((1)) FOR [IsActive]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_LeadDispositions_IsDeleted' AND type = 'D')
ALTER TABLE [QAL].[LeadDispositions] ADD  CONSTRAINT [DF_LeadDispositions_IsDeleted]  DEFAULT ((0)) FOR [IsDeleted]
GO

IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_LeadDispositions_ModifiedDate' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_LeadDispositions_ModifiedById' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_LeadDispositions_CreatedDate' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_LeadDispositions_CreatedById' AND type = 'D')
...
IF NOT EXISTS (SELECT * FROM sys.objects WHERE name = 'DF_LeadDispositions_DEX_ROW_TS' AND type = 'D')
ALTER TABLE [QAL].[LeadDispositions] ADD  CONSTRAINT [DF_LeadDispositions_DEX_ROW_TS]  DEFAULT (sysdatetimeoffset()) FOR [DEX_ROW_TS]
GO

IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_LeadDispositions_Dealers')
ALTER TABLE [QAL].[LeadDispositions]  WITH CHECK ADD  CONSTRAINT [FK_LeadDispositions_Dealers] FOREIGN KEY([DealerId])
REFERENCES [ACC].[Dealers] ([DealerID])
GO

ALTER TABLE [QAL].[LeadDispositions] CHECK CONSTRAINT [FK_LeadDispositions_Dealers]
GO
