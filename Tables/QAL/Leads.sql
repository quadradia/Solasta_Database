...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'Leads' AND schema_id = SCHEMA_ID('QAL'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Leads_Dealers')
ALTER TABLE [QAL].[Leads]  WITH CHECK ADD  CONSTRAINT [FK_Leads_Dealers] FOREIGN KEY([DealerId])
REFERENCES [ACC].[Dealers] ([DealerID])
GO

IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Leads_Languages')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Leads_LeadAddresses')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Leads_LeadDispositions')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Leads_LeadSources')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Leads_MasterFiles')
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Leads_Season')
ALTER TABLE [QAL].[Leads]  WITH CHECK ADD  CONSTRAINT [FK_Leads_Season] FOREIGN KEY([SeasonId])
REFERENCES [RSU].[Seasons] ([SeasonID])
GO

IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_Leads_TeamLocations')
...
ALTER TABLE [QAL].[Leads] CHECK CONSTRAINT [FK_Leads_Dealers]
GO
