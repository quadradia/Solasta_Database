...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_Address_AddressValidationStates')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_Address_AddressValidationVendors')
...
ALTER TABLE [QAL].[LeadAddresses]  WITH CHECK ADD  CONSTRAINT [FK_Address_DealerTenants] FOREIGN KEY([DealerTenantId])
REFERENCES [ACC].[DealerTenants] ([DealerTenantID])
GO

IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_Address_Languages')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_Address_PoliticalCountries')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_Address_PoliticalStates')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_Address_TeamLocations')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_LeadAddresses_AddressStreetTypes')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_LeadAddresses_PoliticalTimeZones')
...
ALTER TABLE [QAL].[LeadAddresses] CHECK CONSTRAINT [FK_Address_DealerTenants]
GO
