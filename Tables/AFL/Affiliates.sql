...
IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'DF_Affiliates_DEX_ROW_TS' AND type = 'D')
...
ALTER TABLE [AFL].[Affiliates]  WITH CHECK ADD  CONSTRAINT [FK_Affiliates_AffiliateTypeId] FOREIGN KEY([AffiliateTypeId])
REFERENCES [AFL].[AffiliateTypes] ([AffiliateTypeID])
GO
