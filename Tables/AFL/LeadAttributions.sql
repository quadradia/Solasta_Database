...
IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'UQ_LeadAttributions_LeadId' AND type = 'UQ')
ALTER TABLE [AFL].[LeadAttributions] ADD CONSTRAINT [UQ_LeadAttributions_LeadId] UNIQUE ([LeadId])
GO

IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'DF_LeadAttributions_AttributedDate' AND type = 'D')
...
IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'DF_LeadAttributions_ModifiedById' AND type = 'D')
...
IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'DF_LeadAttributions_CreatedDate' AND type = 'D')
...
IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'DF_LeadAttributions_CreatedById' AND type = 'D')
...
IF NOT EXISTS (SELECT *
FROM sys.objects
WHERE name = 'DF_LeadAttributions_DEX_ROW_TS' AND type = 'D')
...
WHERE name = 'FK_LeadAttributions_Leads')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_LeadAttributions_CampaignPlacements')
...
IF NOT EXISTS (SELECT *
FROM sys.foreign_keys
WHERE name = 'FK_LeadAttributions_TokenClicks')
